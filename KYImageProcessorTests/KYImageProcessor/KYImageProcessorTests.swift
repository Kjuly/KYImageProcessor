...
final class KYImageProcessorTests: XCTestCase {
  ...
  func testRevisedFrame() throws {
    ...
    XCTAssertEqual(KYImageProcessor.revisedFrame(frame, with: boudningFrame),
  ...
  func testOffsetFromBoundingAreaAfterImageRotated() throws {
    ...
    // I: 0 <= angle <= M_PI_2
    //
    offset = KYImageProcessor.offsetFromBoundingAreaAfterImageRotated(angle: 0, imageSize: imageSize)
    XCTAssertEqual(offset.x, 0)
    XCTAssertEqual(offset.y, 0)

    offset = KYImageProcessor.offsetFromBoundingAreaAfterImageRotated(angle: PI_2 / 2, imageSize: imageSize)
    ...
    offset = KYImageProcessor.offsetFromBoundingAreaAfterImageRotated(angle: PI_2, imageSize: imageSize)
    XCTAssertEqual(offset.x, 0)
    ...
    //
    offset = KYImageProcessor.offsetFromBoundingAreaAfterImageRotated(angle: PI_2 + PI_2 / 2, imageSize: imageSize)
    ...
    offset = KYImageProcessor.offsetFromBoundingAreaAfterImageRotated(angle: PI, imageSize: imageSize)
    ...
    offset = KYImageProcessor.offsetFromBoundingAreaAfterImageRotated(angle: -PI + PI_2 / 2, imageSize: imageSize)
